...
class ComfirmCode extends StatefulWidget {
  final String verificationID;
  const ComfirmCode({Key key, this.verificationID}) : super(key: key);

  @override
  State<ComfirmCode> createState() => _ComfirmCodeState();
}

class _ComfirmCodeState extends State<ComfirmCode> {
  ...
  phoneConfirm(smsCODE, verID, context) {
    ...
    state.signInWithCredential(authCredential, context);
  }
}
