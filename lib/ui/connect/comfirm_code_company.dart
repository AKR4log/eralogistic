...
class ComfirmCodeCompany extends StatefulWidget {
  final String verificationID;
  const ComfirmCodeCompany({Key key, this.verificationID}) : super(key: key);

  @override
  State<ComfirmCodeCompany> createState() => _ComfirmCodeCompanyState();
}

class _ComfirmCodeCompanyState extends State<ComfirmCodeCompany> {
  ...
  phoneConfirm(smsCODE, verID, context) {
    ...
    state.signInWithCredentialCompany(authCredential, context);
  }
}
